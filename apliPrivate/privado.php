    ...
    <main class="mainprivado">
        ...
        <?php
            ...
            <table class=tablaprivado>
                <tbody>
                    <tr> <th class=celdaSobrante>Activo</th> <th class=celdaSobrante>Id</th> <th>Nombre</th> <th class=celdaSobrante>Alias</th> 
                    <th class=celdaSobrante>Incentivo</th> <th class=celdaSobrante>Salario</th> 
                    <th>Nº Hr ausente</th><th>Nª Hr retraso</th> </tr> ";
            /**
            ...
            while( $sentencia->fetch() ){
                echo  "
                <tr>
                    <td class=celdaSobrante>$activo</td>
                    <td class=celdaSobrante>$idEmpleado</td>
                    <td>$nombreCompleto</td>
                    <td class=celdaSobrante>$aliasEmpleado</td>
                    <td class=celdaSobrante>$prIncentivo%</td>
                    <td class=celdaSobrante>$salario</td>
                    <td> 
